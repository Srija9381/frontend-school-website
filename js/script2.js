...
const numberOfImages = 56; // Change this to the number of images you have
const imageFolderPath = 'images/annual/'; // Path to the folder containing the images

// Create image elements and add to the container
for (let i = 1; i <= numberOfImages; i++) {
    const img = document.createElement('img');
    img.src = `${imageFolderPath}images${i}.JPG`; // Assuming images are named as image1.jpg, image2.jpg, etc.
    img.alt = `Image ${i}`;
